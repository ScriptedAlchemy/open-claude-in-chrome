...
describe("open-claude-in-chrome package exports", () => {
  ...
  test("main entrypoint exports browser tool manifest", async () => {
    ...
    expect(mod.CHROME_TOOL_NAMES).toContain("browser_dialogs")
    expect(mod.CHROME_TOOL_NAMES).toContain("browser_dialog")
    expect(mod.CHROME_BROWSER_TOOLS.length).toBe(26)
  })
})
